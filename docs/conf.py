...
project = 'acoustics'
copyright = '2013-2026, Python Acoustics contributors'
...
latex_documents = [
    ('index', 'acoustics.tex', 'acoustics Documentation', 'Frederik Rietdijk', 'manual'),
]
...
man_pages = [('index', 'acoustics', 'Acoustics Documentation', ['Frederik Rietdijk'], 1)]
